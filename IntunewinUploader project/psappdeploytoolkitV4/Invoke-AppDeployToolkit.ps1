...
function Install-ADTDeployment
{
    ...
    Set-ADTRegistryKey -Key $registryKeyPath -Name $registryValueName -Value $appVersion -Type String
    ...
    {
    Show-ADTInstallationPrompt -Title 'Installation' -Subtitle "$($adtSession.AppName)" -Message "Installationen av $($adtSession.AppName) är klar." -ButtonRightText 'OK' -Icon Information -NoWait
    }
}
...
function Uninstall-ADTDeployment
{
    ...
    ## Prompt to close specified applications
    Show-ADTInstallationWelcome -CloseProcesses @('csc_ui', 'dnscryptproxy', 'vpnagent', 'acumbrellaagent') -CloseProcessesCountdown 60
